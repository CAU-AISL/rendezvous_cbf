classdef NominalOmega < handle
    % NominalOmega Implements CLF-CBF-QP based nominal controller
    ...
    methods
        function obj = NominalOmega(control_setting, relativeDynamics)
        ...
        function [tau, slack, feas] = command(obj, omega_d)
            state = obj.RelativeChaser.state;
            obj.update_clf(state, omega_d);
        ...
        % ========================================================
        function update_clf(obj, state, omega_d)
            % Compute value of control lyapunov function V
            omega = state(4:6);
            e_omg = omega_d - omega;
            obj.V = 0.5*(e_omg' * e_omg);
            
            c1 = obj.RelativeChaser.get_C1();
            d1 = obj.RelativeChaser.get_D1();
            
            obj.LfV = -e_omg' * obj.RelativeChaser.inv_J_c * c1 * omega - e_omg' * obj.RelativeChaser.inv_J_c * d1;
            obj.LgV = -e_omg' * obj.RelativeChaser.inv_J_c;
        end
